...
Seshia es una aplicacion web de seguimiento de ciclo menstrual y finanzas personales. Su objetivo es ayudar a entender como el ciclo influye en el estado de animo, la energia y los patrones de gasto a traves de insights generados automaticamente.
...
# En otra terminal, ejecutar migraciones y datos iniciales
